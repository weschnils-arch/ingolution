    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="solution-heading text-center mb-16 md:mb-20">
          ...
          <h2
            className="font-display font-800 text-[var(--color-text)] tracking-tight pb-2"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="solution-visual relative">
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-[var(--color-surface-3)]">
              <img
                src="/solution-protect.webp"
                alt="So schützt Ingolution Ihr Business"
